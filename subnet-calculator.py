#!/usr/bin/python        
""" Sample output
Hiteshs-MacBook-Air:python hitesha$ ./subnet-calculator.py 


Enter an IP address: 192.168.10.20
...
Random IP address is: 192.168.10.240


Generate random ip address from subnet? (y/n)y
Random IP address is: 192.168.10.234
